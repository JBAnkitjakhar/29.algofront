...
function TopicContent() {
  ...
  // ✅ Wrap documents in useMemo to prevent re-creation on every render
  const documents = useMemo(() => docsData?.docs || [], [docsData?.docs]);

  // Calculate read count for this topic
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div className="flex items-center justify-center">
              ...
              <div className="text-center">
                ...
                <div className="mt-1 flex items-center justify-center space-x-4 text-sm text-gray-400">
